...
def lgn():
    if txtuser.get() == "" or txtpwd.get() == "":
        ...
        if (
            (str(txtuser.get()) == "Nathan" and str(txtpwd.get()) == "11213")
            or (str(txtuser.get()) == "Kevin" and str(txtpwd.get()) == "12213")
            or (str(txtuser.get()) == "Harris" and str(txtpwd.get()) == "12209")
            or (str(txtuser.get()) == "Jeswin" and str(txtpwd.get()) == "12212")
            or (str(txtuser.get()) == "Guru" and str(txtpwd.get()) == "12206")
            or (str(txtuser.get()) == "Jai Praveen" and str(txtpwd.get()) == "12210")
            or (str(txtuser.get()) == "Harish" and str(txtpwd.get()) == "12207")
        ):
            ...
            def add():
                ...
                def append():
                    if (
                        ...
                        Handle.close()
                        messagebox.showinfo(
                            "INFORMATION", "Record has been updated successfully."
                        )
                ...
                my_canvas2.create_text(
                    507,
                    50,
                    text="HC HOSPITAL",
                    font=("Helevetica", 50, "bold"),
                    fill="black",
                )
                my_canvas2.create_text(
                    500,
                ...
                txtname = Entry(
                    root2, font=("Helevetica", 30, "bold"), width=17, bd=5, fg="red4"
                )
                ...
                txtgen = Entry(
                    root2, font=("Helevetica", 30, "bold"), width=7, bd=5, fg="red4"
                )
                txtgen.place(x=657, y=220)

                my_canvas2.create_text(
                    157, 250, text="Age :", font=("Helevetica", 35, "bold"), fill="red4"
                )
                my_canvas2.create_text(
                    150,
                    250,
                ...
                txtage = Entry(
                    root2, font=("Helevetica", 30, "bold"), width=4, bd=5, fg="red4"
                )
                ...
                txtarea = Text(
                    ...
                    wrap="word",
                    fg="red4",
                )  # wrap is used for the complete word which goes to new line
                txtarea.place(x=257, y=420)

                man = PhotoImage(file="man.png")
                manbtn = Button(root2, image=man, bd=5, command=append).place(
                    x=470, y=580
                )

                cls1 = PhotoImage(file="exit2.png")
                clsbtn1 = Button(root2, bd=5, image=cls1, command=exit2).place(
                    x=570, y=580
                )

                rpt = PhotoImage(file="repeat.png")
                rptbtn = Button(root2, image=rpt, bd=5, command=repeat).place(
                    x=370, y=580
                )
            ...
            def search():
                    ...
                    if txtsname.get() == "" or txtspn.get() == "":
                        ...
                        with open("HC.log", "rb") as S:
                            ...
                            try:
                                while True:
                                    med = pickle.load(S)
                                    if med["Name"] == str(txtsname.get()) and med[
                                        "Patient number"
                                    ] == int(txtspn.get()):
                                        name = med["Name"]
                                        age = med["Age"]
                                        ...
                                        rep = med["Report"]
                                        txtarea1.insert(
                                            END, f"Name of the patient:{str(name)}"
                                        )
                                        txtarea1.insert(
                                ...
                                if flag == False:
                                    messagebox.showerror(
                                        "ERROR", "No medical record is found"
                                    )
                                    S.close()
                ...
                my_canvas3.create_text(
                    87, 150, text=" Name:", font=("Helevetica", 35, "bold"), fill="red4"
                )
                my_canvas3.create_text(
                    80,
                    150,
                ...
                txtsname = Entry(
                    root3, font=("Helevetica", 30, "bold"), width=12, bd=5, fg="red4"
                )
                ...
                txtspn = Entry(
                    root3, font=("Helevetica", 30, "bold"), width=5, bd=5, fg="red4"
                )
                ...
                srchbtn1 = Button(root3, bd=5, image=srch1, command=find).place(
                    x=470, y=580
                )

                cls2 = PhotoImage(file="exit2.png")
                clsbtn2 = Button(root3, bd=5, image=cls2, command=exit3).place(
                    x=570, y=580
                )

                rpt1 = PhotoImage(file="repeat.png")
                rptbtn1 = Button(root3, image=rpt1, bd=5, command=repeat1).place(
                    x=370, y=580
                )
                root3.mainloop()
            ...
            srchbtn = Button(root1, bd=5, image=srch, command=search).place(
                x=150, y=220
            )

            profile = PhotoImage(file="profile.png")
            prfibtn = Button(root1, bd=5, image=profile, command=add).place(
                x=650, y=220
            )
            ...
            my_canvas1.create_text(
                260, 470, text="Search", font=("Helevetica", 35, "bold"), fill="red4"
            )
            my_canvas1.create_text(
                253, 470, text="Search", font=("Helevetica", 35, "bold"), fill="white"
            )

            my_canvas1.create_text(
                760, 470, text="Add", font=("Helevetica", 35, "bold"), fill="red4"
            )
            my_canvas1.create_text(
                753, 470, text="Add", font=("Helevetica", 35, "bold"), fill="white"
            )
...
my_canvas.create_text(
    507, 50, text="HC HOSPITAL", font=("Helevetica", 50, "bold"), fill="black"
)
my_canvas.create_text(
    500, 50, text="HC HOSPITAL", font=("Helevetica", 50, "bold"), fill="white"
)


my_canvas.create_text(
    257, 200, text="Enter the username:", font=("Helevetica", 35, "bold"), fill="red4"
)
my_canvas.create_text(
    250, 200, text="Enter the username:", font=("Helevetica", 35, "bold"), fill="white"
)
...
my_canvas.create_text(
    257, 300, text="Enter the password:", font=("Helevetica", 35, "bold"), fill="red4"
)
my_canvas.create_text(
    250, 300, text="Enter the password:", font=("Helevetica", 35, "bold"), fill="white"
)
